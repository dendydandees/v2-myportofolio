<template>
  <article
    id="home"
    class="p-4 min-h-screen bg-gradient-to-tl from-yellow-500 dark:from-yellow-600 to-purple-500 dark:to-purple-600 lg:p-6 z-0"
  >
    <div class="relative container pt-20 mx-auto space-y-6 z-10">
